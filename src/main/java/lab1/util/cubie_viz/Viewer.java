...
{
	boolean disabledMouseMoves = false;
	Image offImage;
	...
	public void setDisabledMouseMoves(boolean disable) {
		this.disabledMouseMoves = disable;
	}
...
//--- mouse routines ---
    ...
    public void tryMove( int m0, int q0 )
	{
      ...
      int m = m0;
		...
		if (!this.disabledMouseMoves || (this.disabledMouseMoves && m >= 9)) {
			doMove(m,q);
		}
	}
